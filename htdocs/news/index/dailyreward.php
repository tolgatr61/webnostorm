                ...
                <div class="col-lg-6">
                    <div class="nk-product-cat-2">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="#">{name}</a></h3>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-rating" data-rating="5"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                            <div class="nk-gap-1"></div>
                            {description}
                            <div class="nk-gap-2"></div>
                            <div class="nk-product-price">{daysnumber}</div>
                            <div class="nk-gap-1"></div>
                            <br>
                            <br>
                            <br>
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Récolter la récompense</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
