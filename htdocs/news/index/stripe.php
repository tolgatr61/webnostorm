...
<head>
	...
	<title><?php echo $site['name']; ?> - Stripe</title>
						...
						<div class="col-lg-6">
							<div class="nk-product-cat-2">
								...
								<div class="nk-product-cont">
									...
									<div class="nk-gap-1"></div>
									<form action="charge.php?CoinsId=<?= $result["CoinsId"]; ?>" method="POST">
										<script
										src="https://checkout.stripe.com/checkout.js" class="stripe-button"
										data-key="pk_live_me9VmJUpKN5uBOj4IVawvssV"
										data-locale="auto"
										data-amount="<?= $result["Price"]; ?>00"
										data-currency="eur">
									</script>
								</form>
							</div>
