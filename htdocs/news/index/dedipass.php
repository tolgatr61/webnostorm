...
<head>
	...
	<title><?php echo $site['name']; ?> - Dédipass</title>
	...
	<script src="//api.dedipass.com/v1/pay.js"></script> <!-- MOVE IT INTO A PROPER PAGE -->
	<!-- call/:scripts -->
</head>
<body>
...
<!-- END : Navbar -->
		...
		<div class="nk-main">
			...
			<div class="container">
				...
				<div class="nk-gap-1"></div>
				<div data-dedipass="6b5ceeb211bb9c632093cdcaec9c169e" data-dedipass-custom=""></div>
			</div>
		<!-- END: Products -->
...
<div class="nk-modal modal fade" id="modalLogin" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<?php
		...
		if(empty($code)) {
		  ...
		  $dedipass = file_get_contents('http://api.dedipass.com/v1/pay/?public_key=6b5ceeb211bb9c632093cdcaec9c169e&private_key=86eeee733e9526daca456d7e35b75e055c9c30ed&code=' . $code);
		  ...
		  if($dedipass->status == 'success') {
			...
			if(empty($req2->fetch()))
			{
				...
				$req1->execute([$_SESSION["AccountId"], $virtual_currency]);
			}
			else
			{
			    $req = $conn->prepare("UPDATE CoinsDreamTrix SET Coins = Coins + ? WHERE AccountId = ?");
			    $req->execute([$virtual_currency, $_SESSION["AccountId"]]);
			}
		    $_SESSION["Success"] = "Votre compte a été crédité de <?= $virtual_currency ?> coins merci pour votre soutient !";
		  }
		  else {
		    $_SESSION["Error"] = "Le code entré est invalide ! Essayez de mettre un point à la fin du code !";
		  }
		}
	?> 